...
tmux is not what an unconfigured home resolves to; the selection order owned by [`configuration.md`](configuration.md#runtime-backend-configbackend--fm_backend) says what is.
