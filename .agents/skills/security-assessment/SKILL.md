...
Follow it to its body and look for an environment branch, and establish for yourself what each side of that branch permits rather than taking a guard's name for its behaviour.
