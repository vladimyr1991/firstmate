...
The step keeps the condition that produces the fact and the result it produces, and the operating sequence's step 2 stays the owner of which ship base is recorded, by what, and when.
